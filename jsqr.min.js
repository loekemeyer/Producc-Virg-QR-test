/*! jsQR v1.4.0 — QR code decoding. Vendorizado (offline PWA). 
    (c) Cosmo Wolfe. Licencia Apache-2.0: https://github.com/cozmo/jsQR
    Expone el global `jsQR(imageData, width, height)`. */
